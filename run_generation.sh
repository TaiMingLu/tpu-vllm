...
# Input/Output paths (adjust these to your data location)
INPUT_PARQUET="/home/terry/gcs-bucket/data/input.parquet"
OUTPUT_PARQUET="/home/terry/gcs-bucket/data/output_with_completions.parquet"
...
gcloud compute tpus tpu-vm ssh terry@${TPU_NAME} \
  ...
  --command="
    ...
    mkdir -p ~/work-dir/generation
    cd ~/work-dir/generation
...
# Import and run main from the embedded script above
